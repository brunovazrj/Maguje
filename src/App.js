...
// Parse XLSX attendance file → { "NOME COMPLETO": [day, day, ...] }
...
const INITIAL_EMPLOYEES = [
  { id: 1,  name: "Douglas Pereira Lima",              role: "Garçom",               sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 2,  name: "Gabriel de Farias Pereira",         role: "Garçom",               sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 3,  name: "Gustavo Fabricio Rodrigues Freire", role: "Garçom",               sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 4,  name: "Antonia Erineuda",                  role: "Garçonete",            sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 5,  name: "Paulo Alves de Almeida",            role: "Garçom",               sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 6,  name: "Reinaldo Alves de Oliveira",        role: "Chefe de Fila Junior", sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 7,  name: "Jeane Rodrigues",                   role: "Chefe de Fila Junior", sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 8,  name: "Verinaldo Gabriel da Rocha",        role: "Chefe de Fila Junior", sector: "Salão",   type: "individual", points: 0,  mei: false },
  { id: 9,  name: "Jean Carlos Fidelis",               role: "Cumim",                sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 10, name: "Claudia Elisabete Conceição",       role: "Cumim",                sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 11, name: "Marcos Vinicius Henrique de Souza", role: "Cumim",                sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 12, name: "Maria Elenice Ferreira",            role: "Cumim",                sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 13, name: "Rodrigo de Pinho Ribeiro",          role: "Cumim",                sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 14, name: "Felipe Costa de Abreu",             role: "Suiteiro",             sector: "Salão",   type: "global",     points: 20, mei: false },
  { id: 15, name: "Crislandia Moura de Lima",          role: "Chefe de Fila Pleno",  sector: "Salão",   type: "global",     points: 26, mei: false },
  { id: 16, name: "Elizangelo Araujo Miranda",         role: "Maître",               sector: "Salão",   type: "global",     points: 30, mei: false },
  { id: 17, name: "Joaquim Fernandes Gomes",           role: "Assistente Gerente",   sector: "Salão",   type: "global",     points: 25, mei: false },
  { id: 18, name: "Jose Edilson Pereira Nogueira",     role: "Sub Gerente / Maître", sector: "Salão",   type: "global",     points: 30, mei: false },
  { id: 19, name: "Rodrigo Florentino Fonseca",        role: "Gerente",              sector: "Salão",   type: "global",     points: 35, mei: false },
  { id: 20, name: "Fabio da Silva Miguel",             role: "Assistente MKT",       sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 21, name: "Kayllana Vitoria de Oliveira",      role: "Hostess",              sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 22, name: "Suzana Radai Estrela Souza",        role: "Hostess",              sector: "Salão",   type: "global",     points: 15, mei: false },
  { id: 23, name: "Romenia Fernades Jorge",            role: "Hostess",              sector: "Salão",   type: "global",     points: 20, mei: false },
  ...
  { id: 36, name: "Douglas Leite Gonçalves",           role: "Copeiro",              sector: "Cozinha", type: "global",     points: 15, mei: false },
  ...
  { id: 52, name: "Luis Augusto Souza da Costa",       role: "Cozinheiro Líder",     sector: "Cozinha", type: "global",     points: 23, mei: false },
  { id: 53, name: "Jaqueline de Souza Galvao",         role: "Sub Chefe Cozinha",    sector: "Cozinha", type: "global",     points: 25, mei: false },
  { id: 54, name: "Eduardo",                           role: "Chef Produções Gast.", sector: "Cozinha", type: "global",     points: 30, mei: false },
  ...
  { id: 57, name: "Marlucia Santana Rodrigues",        role: "Líder de ASG",         sector: "Limpeza", type: "global",     points: 20, mei: false },
  { id: 58, name: "José Roberto Inácio da Silva",      role: "Estoquista",           sector: "Limpeza", type: "global",     points: 10, mei: false },
];
...
// Parse day string "02/04 QUI" → day number (2)
...
function calcResults(employees, workDays, dailyRevenue, globalMonthlyRevenue, addicionais, absences) {
  ...
  // Individual commissions — per day per employee
    ...
    <div style={{fontFamily:"'DM Mono','Courier New',monospace",background:"#F5F0E8",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center"}}>
      ...
      <div style={{width:"100%",maxWidth:380,padding:"0 20px"}}>
        <div style={{textAlign:"center",marginBottom:36}}>
          <div style={{width:56,height:56,background:"#1B4332",borderRadius:12,margin:"0 auto 16px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26}}>🌿</div>
        ...
        <div className={shake?"shake":""} style={{background:"#fff",border:"1.5px solid #D4CFC4",borderRadius:6,padding:"28px 28px 24px"}}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{marginBottom:16}}>
              ...
              <input type="password" placeholder="••••••••" value={pwd} autoFocus onChange={e=>{setPwd(e.target.value);setError(false);}}
...
function EmployeeForm({ initial, onSave, onCancel }) {
  ...
  return (
    <div style={{background:"#fff",border:"1.5px solid #52B788",borderRadius:4,padding:"16px 18px",marginBottom:16}}>
      <div style={{fontSize:11,color:"#1B4332",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:12}}>{initial.id?"Editar Funcionário":"Novo Funcionário"}</div>
      <div style={{display:"flex",gap:10,flexWrap:"wrap",alignItems:"flex-end"}}>
        ...
        <div style={{flex:"1 1 100px"}}><div style={{fontSize:11,color:"#555",marginBottom:4}}>Setor</div>
          <select value={emp.sector} onChange={e=>f("sector",e.target.value)} style={inp}>{["Salão","Bar","Caixa","Cozinha","Limpeza"].map(x=><option key={x}>{x}</option>)}</select></div>
        <div style={{flex:"1 1 130px"}}><div style={{fontSize:11,color:"#555",marginBottom:4}}>Tipo</div>
          <select value={emp.type} onChange={e=>f("type",e.target.value)} style={inp}><option value="individual">Individual (Garçom/Chefe)</option><option value="global">Global (Pool por pontos)</option></select></div>
        ...
        <div style={{flex:"0 1 80px"}}>
          ...
          <label style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",padding:"6px 0"}}>
            ...
            <span style={{fontSize:12,color:emp.mei?"#2D6A4F":"#888"}}>{emp.mei?"Sim":"Não"}</span>
          </label>
        </div>
...
// ── EMPLOYEE MANAGER ─────────────────────────────────────────────────────────
function EmployeeManager({ employees, onAdd, onEdit, onDelete }) {
  const [open, setOpen] = useState(false);
  const [mode, setMode] = useState(null);
  const [confirmDelete, setConfirmDelete] = useState(null);
  const [filterSector, setFilterSector] = useState("Todos");
  const filtered = filterSector==="Todos" ? employees : employees.filter(e=>e.sector===filterSector);
  const btnSm = (c,bg="transparent") => ({border:`1px solid ${c}`,background:bg,color:bg!=="transparent"?"#fff":c,padding:"4px 10px",borderRadius:3,cursor:"pointer",fontFamily:"inherit",fontSize:11,fontWeight:500});
  return (
    <div style={{marginBottom:16}}>
      <button style={{border:"1.5px solid #1B4332",background:open?"#1B4332":"transparent",color:open?"#fff":"#1B4332",padding:"7px 16px",borderRadius:3,cursor:"pointer",fontFamily:"inherit",fontSize:13,fontWeight:500,transition:"all 0.15s"}}
        onClick={()=>{setOpen(o=>!o);setMode(null);setConfirmDelete(null);}}>
        {open?"✕ Fechar Gerenciamento":"👥 Gerenciar Funcionários"}
      </button>
      {open && (
        <div style={{background:"#fff",border:"1.5px solid #D4CFC4",borderRadius:4,padding:"18px 20px",marginTop:12}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14,flexWrap:"wrap",gap:8}}>
            <div style={{fontSize:11,color:"#1B4332",textTransform:"uppercase",letterSpacing:"0.08em",fontWeight:600}}>
              {employees.length} funcionários cadastrados
            </div>
            <button style={{...btnSm("#1B4332","#1B4332"),fontSize:12,padding:"6px 14px"}}
              onClick={()=>setMode(mode==="add"?null:"add")}>
              {mode==="add"?"✕ Cancelar":"+ Novo Funcionário"}
            </button>
          </div>
          {mode==="add" && (
            <div style={{marginBottom:16,padding:"14px 16px",background:"#f0faf4",border:"1px solid #52B78860",borderRadius:4}}>
              <EmployeeForm initial={{name:"",role:"",sector:"Salão",type:"individual",points:15,mei:false}}
                onSave={(emp)=>{onAdd(emp);setMode(null);}} onCancel={()=>setMode(null)}/>
            </div>
          )}
          <div style={{display:"flex",gap:6,marginBottom:14,flexWrap:"wrap"}}>
            {SECTORS.map(s=>(
              <button key={s} style={{padding:"5px 12px",border:`1px solid ${filterSector===s?"#1B4332":"#ccc"}`,borderRadius:20,cursor:"pointer",fontSize:11,background:filterSector===s?"#1B4332":"transparent",color:filterSector===s?"#fff":"#555",fontFamily:"inherit"}}
                onClick={()=>setFilterSector(s)}>{s}</button>
            ))}
          </div>
          <div style={{maxHeight:420,overflowY:"auto"}}>
            {["individual","global"].map(type=>{
              const group=filtered.filter(e=>e.type===type);
              if(!group.length) return null;
              return (
                <div key={type}>
                  <div style={{fontSize:10,color:"#1B4332",textTransform:"uppercase",letterSpacing:"0.08em",fontWeight:600,padding:"8px 0 6px",borderBottom:"1px solid #eee",marginBottom:4}}>
                    {type==="individual"?"Garçons e Chefes de Fila Junior":"Equipe Global"}
                  </div>
                  {group.map((emp,idx)=>{
                    const isEditing=mode===emp.id;
                    const isConfirm=confirmDelete===emp.id;
                    return (
                      <div key={emp.id}>
                        {isEditing ? (
                          <div style={{padding:"10px 0",borderBottom:"1px solid #f0f0f0"}}>
                            <EmployeeForm initial={emp}
                              onSave={(u)=>{onEdit(u);setMode(null);}} onCancel={()=>setMode(null)}/>
                          </div>
                        ) : (
                          <div style={{display:"flex",alignItems:"center",gap:8,padding:"8px 6px",borderBottom:"1px solid #f5f5f5",background:idx%2===0?"#fff":"#fafaf8",borderRadius:3}}>
                            <div style={{flex:1,minWidth:0}}>
                              <div style={{fontSize:12,fontWeight:500,display:"flex",alignItems:"center",gap:5,flexWrap:"wrap"}}>
                                {emp.name}
                                {emp.mei&&<span style={{fontSize:10,padding:"1px 6px",borderRadius:20,background:"#fff3cd",color:"#856404",border:"1px solid #ffc107",fontWeight:600}}>MEI</span>}
                              </div>
                              <div style={{fontSize:10,color:SECTOR_COLORS[emp.sector]||"#888",marginTop:1}}>
                                {emp.role} · {emp.sector}{emp.type==="global"?` · ${emp.points}pts`:" · 29% individual"}
                              </div>
                            </div>
                            {isConfirm ? (
                              <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
                                <span style={{fontSize:11,color:"#c0392b"}}>Confirmar?</span>
                                <button style={btnSm("#c0392b","#c0392b")} onClick={()=>{onDelete(emp.id);setConfirmDelete(null);}}>Sim</button>
                                <button style={btnSm("#666")} onClick={()=>setConfirmDelete(null)}>Não</button>
                              </div>
                            ) : (
                              <div style={{display:"flex",gap:6,flexShrink:0}}>
                                <button style={btnSm("#1B4332")} onClick={()=>setMode(emp.id)}>✏ Editar</button>
                                <button style={btnSm("#c0392b")} onClick={()=>setConfirmDelete(emp.id)}>🗑 Deletar</button>
                              </div>
                            )}
                          </div>
                        )}
...
function MainApp() {
  ...
  const handleAttendanceImport = (file) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (!XLSX) { alert("Biblioteca de leitura não carregada. Recarregue a página."); return; }
  ...
  const handleDeleteEmployee = (id) => setEmployees(p=>p.filter(e=>e.id!==id));
  ...
  const PrintContent = () => {
    ...
    return (
      <div>
        ...
        <div className="sub">Referência: {displayMonthLabel} · Gerado em {new Date().toLocaleDateString("pt-BR")}</div>
        <div className="summary">
          {[{label:"Total Bruto",val:fmt(displayResults.totalBruto)},{label:"Pool Global Líq.",val:fmt(displayResults.totalGlobalPool)},{label:"Comissões Indiv.",val:fmt(displayResults.totalIndivComm)},{label:"Total Distribuído",val:fmt(totalComm)}].map(m=>(
        ...
        {sectors.map(sec=>{
          ...
          return (
            <table key={sec}>
              ...
              <tr><th>Funcionário</th><th>Cargo</th><th>Tipo</th><th>Faltas</th><th style={{textAlign:"right"}}>Comissão</th></tr></thead>
              <tbody>{secEmps.sort((a,b)=>(displayResults.empTotals[b.id]||0)-(displayResults.empTotals[a.id]||0)).map(emp=>(
                <tr key={emp.id}><td>{emp.name}{emp.mei?" MEI":""}</td><td>{emp.role}</td>
                  ...
                  <td>{absCount(emp.id)>0?absCount(emp.id)+" dia(s)":"—"}</td>
    ...
    <div style={{fontFamily:"'DM Mono','Courier New',monospace",background:"#F5F0E8",minHeight:"100vh"}}>
      ...
      {showHistory && (
        <div style={{background:"#fff",borderBottom:"1px solid #D4CFC4",padding:"16px 24px"}}>
          <div style={{fontSize:11,color:"#666",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:12}}>Histórico de Comissões Salvas</div>
          {history.length===0 ? <div style={{fontSize:13,color:"#aaa"}}>Nenhum mês salvo ainda.</div>
          ...
          <>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:16,marginBottom:20}}>
              ...
              <div style={{background:"#fff",border:"1.5px solid #40916C",borderRadius:4,padding:"18px 20px"}}>
                <div style={{fontSize:11,color:"#40916C",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:8,fontWeight:600}}>Faturamento Global do Mês</div>
                <div style={{fontSize:12,color:"#555",marginBottom:12,lineHeight:1.6}}>Vendas sem comissão individual. Desconto de 33% aplicado.</div>
                ...
                {globalMonthlyRevenue && (
                  <div style={{display:"flex",gap:16,flexWrap:"wrap"}}>
                    ...
                    <div><div style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:700,fontSize:14,color:"#40916C"}}>{fmt((parseFloat(globalMonthlyRevenue)||0)*(1-TAX_RATE))}</div><div style={{fontSize:10,color:"#888",textTransform:"uppercase",marginTop:1}}>Líquido (−33%)</div></div>
                  </div>
                )}
              </div>
              {/* Adicionais */}
              <div style={{background:"#fff",border:"1.5px solid #7B5EA7",borderRadius:4,padding:"18px 20px"}}>
                <div style={{fontSize:11,color:"#7B5EA7",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:8,fontWeight:600}}>Adicionais do Mês</div>
                <div style={{fontSize:12,color:"#555",marginBottom:12,lineHeight:1.6}}>Entra no pool global. <strong>Sem desconto de 33%</strong> — valor integral distribuído.</div>
            ...
            {(globalMonthlyRevenue || adicionais) && (
              <div style={{background:"#1B433210",border:"1px solid #1B433230",borderRadius:4,padding:"12px 16px",marginBottom:20,display:"flex",gap:24,flexWrap:"wrap"}}>
                ...
                <div><div style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:700,fontSize:14,color:"#555"}}>{workDays.length} dias úteis</div><div style={{fontSize:10,color:"#666",textTransform:"uppercase",marginTop:2}}>Distribuídos por dia</div></div>
              </div>
            )}

            {/* Employee manager — revenue tab */}
            <EmployeeManager
              employees={employees}
            ...
            <div style={{fontSize:11,color:"#666",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:12,fontWeight:600}}>
              Venda Individual Diária — Garçons e Chefes de Fila Junior (29%)
            </div>
              ...
              <table style={{borderCollapse:"collapse",width:"100%",minWidth:200+workDays.length*60}}>
                ...
                <tbody>
                  ...
                  <tr style={{background:"#F5F0E8"}}>
                    ...
                    {workDays.map(d=>{const tot=indivEmps.reduce((s,e)=>s+(parseFloat(getDR(d).individual[e.id])||0),0);return <td key={d} style={{...S.td,textAlign:"right",fontWeight:600,fontSize:11,background:"#F5F0E8",padding:"7px 5px",color:"#1B4332"}}>{tot>0?fmtShort(tot):"—"}</td>;})}
        ...
        {!viewingHistory && step==="absences" && (
          <>
            ...
            <div style={{background:"#fff",border:"1.5px solid #D4CFC4",borderRadius:4,padding:"18px 20px",marginBottom:16}}>
              <div style={{fontSize:11,color:"#666",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:10,fontWeight:600}}>📎 Importar Planilha de Ponto</div>
              <div style={{fontSize:12,color:"#555",marginBottom:14,lineHeight:1.6}}>
                Importe o arquivo exportado do sistema de ponto (.xlsx). Qualquer marcação na coluna <strong>TIPO</strong> será registrada como falta.
                Após importar, você pode editar manualmente as faltas na tabela abaixo.
              </div>
              <div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
                ...
                {attendanceFile && (
                  <span style={{fontSize:12,color:"#2D6A4F",fontWeight:500}}>✓ {attendanceFile.name}</span>
                )}
                {attendanceFile && (
              ...
              {importLog && (
                <div style={{marginTop:14,padding:"12px 14px",background:"#f0faf4",border:"1px solid #52B78860",borderRadius:4}}>
                  <div style={{fontSize:12,color:"#1B4332",fontWeight:600,marginBottom:6}}>
                    ✓ Importação concluída — {importLog.matched} registros aplicados
                  </div>
                  {importLog.unmatched.length > 0 && (
                    <>
                      <div style={{fontSize:11,color:"#856404",marginBottom:4,fontWeight:500}}>
                        ⚠ {importLog.unmatched.length} nome(s) não encontrado(s) na lista de funcionários:
                      </div>
                      <div style={{fontSize:11,color:"#666",lineHeight:1.8}}>
                        {importLog.unmatched.map(n=><div key={n} style={{padding:"1px 0"}}>• {n}</div>)}
                      </div>
                    </>
                  )}
                </div>
              ...
              <table style={{borderCollapse:"collapse",width:"100%",minWidth:260+workDays.length*42}}>
                <thead>
                  <tr>
                    ...
                    <th style={{...S.th,textAlign:"center",minWidth:70}}>Ações</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                      ...
                      return (
                        <tr key={emp.id} className="row-hover">
                          <td style={{...S.td,position:"sticky",left:0,background:idx%2===0?"#fff":"#fafaf8",zIndex:1}}>
                            ...
                            <div style={{fontSize:10,color:SECTOR_COLORS[emp.sector]||"#888",marginTop:1}}>{emp.role} · {emp.sector}{emp.type==="global"?` · ${emp.points}pts`:""}</div>
                          </td>
                          ...
                          {workDays.map(d=>{
                            ...
                            return <td key={d} style={{...S.td,textAlign:"center",padding:"5px 4px",background:absent?"#fdecea":idx%2===0?"#fff":"#fafaf8"}}>
                              <button className={`absent-btn${absent?" marked":""}`} onClick={()=>toggleAbs(emp.id,d)}>{absent?"F":"·"}</button>
                            </td>;
                          })}
                          <td style={{...S.td,textAlign:"center",background:idx%2===0?"#fff":"#fafaf8"}}>
                            {ac>0?<span style={{background:"#fdecea",color:"#c0392b",borderRadius:10,padding:"2px 8px",fontSize:12,fontWeight:600}}>{ac}</span>:<span style={{color:"#ccc",fontSize:12}}>—</span>}
                          </td>
                          <td style={{...S.td,textAlign:"center",background:idx%2===0?"#fff":"#fafaf8"}}>
                            <button style={S.btnSm("#1B4332")} onClick={()=>{setEditingId(emp.id);setShowAdd(false);}}>✏ Editar</button>
                          </td>
                        </tr>
                      );
                    })}</>
          ...
          <>
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:12,marginBottom:20}}>
              {[
                ...
                {label:"Pool Global Líq.",val:fmt(displayResults.totalGlobalPool),color:"#40916C"},
                {label:"Comissões Indiv.",val:fmt(displayResults.totalIndivComm),color:"#7B5EA7"},
              ].map(m=>(
            ...
            <div style={{display:"flex",gap:6,marginBottom:16,flexWrap:"wrap",alignItems:"center"}}>
              ...
              <div style={{marginLeft:"auto",display:"flex",gap:8}}>
                {!viewingHistory&&<button style={S.btnGreen} onClick={handleSaveHistory}>💾 Salvar Mês</button>}
                <button style={S.btn} onClick={handlePrint}>🖨 Exportar PDF</button>
              </div>
            </div>
            <div style={{overflowX:"auto"}}>
                  ...
                  {filteredEmps.slice().sort((a,b)=>(displayResults.empTotals[b.id]||0)-(displayResults.empTotals[a.id]||0)).map((emp,idx)=>{
                    ...
                    return (
                      <tr key={emp.id} className="row-hover">
                        ...
                        <td style={{...S.td,textAlign:"center",background:idx%2===0?"#fff":"#fafaf8"}}>
                          {emp.type==="individual"?<span style={{fontSize:11,padding:"2px 8px",borderRadius:20,background:"#7B5EA720",color:"#7B5EA7",border:"1px solid #7B5EA740"}}>Individual</span>:<span style={{fontSize:11,padding:"2px 8px",borderRadius:20,background:"#2D6A4F20",color:"#2D6A4F",border:"1px solid #2D6A4F40"}}>Global · {emp.points}pts</span>}
                        </td>
                        <td style={{...S.td,textAlign:"center",background:idx%2===0?"#fff":"#fafaf8"}}>
                          {emp.mei?<span style={{fontSize:10,padding:"2px 8px",borderRadius:20,background:"#fff3cd",color:"#856404",border:"1px solid #ffc107",fontWeight:600}}>MEI</span>:<span style={{color:"#ccc",fontSize:11}}>—</span>}
                        </td>
                        <td style={{...S.td,textAlign:"center",background:idx%2===0?"#fff":"#fafaf8"}}>
                          {ac>0?<span style={{background:"#fdecea",color:"#c0392b",borderRadius:10,padding:"2px 8px",fontSize:12,fontWeight:600}}>{ac} dia{ac>1?"s":""}</span>:<span style={{color:"#ccc",fontSize:12}}>—</span>}
                        </td>
            ...
            {!viewingHistory&&<div style={{marginTop:20}}><button style={S.btnOut} onClick={()=>setStep("absences")}>← Voltar</button></div>}
          </>
        )}
      </div>
